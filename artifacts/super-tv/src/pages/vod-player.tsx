...
export default function VodPlayerPage() {
  ...
  }, [togglePlay, skip, toggleMute, toggleFullscreen, backUrl, setLocation, showControlsTemporarily]);
  ...
  return (
    ...
    >
      ...
      {showNextEp && nextEpisodeId && nextEpisodeUrl && (
        <div className="absolute bottom-28 right-4 z-30 bg-black/85 backdrop-blur border border-white/15 rounded-xl px-4 py-3 flex items-center gap-3 shadow-2xl">
